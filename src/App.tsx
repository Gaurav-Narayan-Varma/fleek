...
function App() {
  ...
  return (
    <div className="App">
      <div className='flex'>
        <section id='nav-bar' className='px-5 w-56 shrink-0 h-auto bg-white text-black font-sans border border-stone-200'>
          <img src={fleekLogo} className='h-20 w-auto' alt='Fleek logo with transparent background' />
          <ul className=''>
