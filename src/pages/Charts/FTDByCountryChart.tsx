  ...
  return (
    <div id="delivery-times">
      <div
        id="chart"
        ref={addToRef}
        className="opacity-0 w-full transition-all translate-x-full duration-1000 mt-1 mb-52 flex gap-4 bg-white justify-center border border-stone-200 rounded-xl"
      >
        <div
          id="bottom-left"
          className="w-full pt-2 bg-white flex-1 rounded-xl basis-1/12"
        >
        ...
        {option === "buyer" ? (
          ...
          >
            ...
            <div
              id="bullet"
              className='opacity-1 transition-all duration-1000 delay-300 before:content-["🚀"] before:text-2xl before:absolute before:-ml-7 before:mt-2.5 basis-1/3'
            >
              Quicker delivery times correlate with more orders across top four
              markets
            </div>
            <div
              id="bullet"
          ...
          >
            ...
            >
              Slower delivery times correlate with more orders, similar to
              vendor fulfillment
            </div>
            <div
              id="bullet"
            ...
            >
              Likewise, factors such as pricing and marketing may outweigh
              delivery time
            </div>
          </div>
        )}
